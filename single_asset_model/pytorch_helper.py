...
class BoundaryNetwork(nn.Module):
    ...
    def _init_weights(self):
        ...
        # last_layer = self.model[-2]  # Get last layer (output layer)
        # init.constant_(last_layer.weight, 0.00000001)  # Set weights to zero
        # init.constant_(last_layer.bias, 0.0)    # Ensure bias is also zero
